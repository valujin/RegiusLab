...
export default function FAQ() {
  ...
  const faqItems = useMemo(() => {
    return faqData.map(({ question, answer }, index) => (
      <div
        key={index}
        className="faq__item"
        onClick={() => toggleFAQ(index)}
        style={{
          border: openIndex === index ? '2px solid #AF7B20' : '2px solid #FFFFFF66',
        }}
      >
  ...
  return (
    <div className="faq">
      ...
      <div className="faq__wrapper">{faqItems}</div>
    </div>
  );
}
